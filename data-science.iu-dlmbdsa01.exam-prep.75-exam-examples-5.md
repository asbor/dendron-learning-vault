...
<mark style="color:green;">1. unsupervised learning</mark>
...
<mark style="color:green;">2. sensitivity</mark>
...
<mark style="color:green;">4. data preservation</mark>
...
<mark style="color:green;">1. media data source.</mark>
...
<mark style="color:green;">3. the chance of event A given knowledge that event B has occurred.</mark>
...
<mark style="color:green;">4. the pre-processing step</mark>
...
<mark style="color:green;">2. testing set.</mark>
...
<mark style="color:green;">2. a better performance by the developed classification model.</mark>
...
<mark style="color:green;">2. measure the performance of a business’s use case.</mark>
...
<mark style="color:green;">1. de-biased and avoided while building the prediction model.</mark>
...
<mark style="color:green;">4. synchronous data transmission.</mark>
...
<mark style="color:green;">2. data collection</mark>

According the test, data collectinis not a part of pr-procsig, but thid surely is a mstake because transmision is definitly not a part of the preprocsing.&#x20;
...
<mark style="color:green;">3. redundant variables.</mark>
...
<mark style="color:green;">3. variable scaling.</mark>
...
<mark style="color:green;">2. pie chart</mark>
...
<mark style="color:green;">3. data.</mark>
...
<mark style="color:green;">2. information.</mark>
...
<mark style="color:green;">1. data preparation</mark>
...
<mark style="color:green;">1. XML data format</mark>
...
<mark style="color:green;">2. data pre-processing</mark>
...
<mark style="color:green;">1. principal component analysis.</mark>
...
<mark style="color:green;">1. group the data records according to their similarity.</mark>
...
<mark style="color:green;">1. a regression model.</mark>
...
<mark style="color:green;">4. linear function between the future output and past outputs.</mark>
...
<mark style="color:green;">1. Fourier transformation.</mark>
...
<mark style="color:green;">2. deal with nonlinearly separable dataset.</mark>
...
<mark style="color:green;">1. get the network’s output value very close to the desired output value.</mark>
...
<mark style="color:green;">3. recurrent networks.</mark>
...
<mark style="color:green;">2. fuzzy logic</mark>
...
<mark style="color:green;">3. random variables.</mark>
